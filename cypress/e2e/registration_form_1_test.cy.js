...
describe('This is first test suite, Karina Palloson', () => {
    it('User can submit data only when valid mandatory values are added', () => {
        //28.04.2024
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('#firstName').type('Rebeka')
        cy.get('#lastName').type('Cat')
        cy.get('input[name="password"]').type('124Password')
        cy.get('[name="confirm"]').type('124Password')
...
/*Assignment 2:
 ...
 2. Replace text ‘124Password’ in the first test with your own chosen password (2 places) - passwords should match
